...
export const CANONICAL_STAGES = [
  ...
  {
    key: "timeline",
    label: "Construir línea de tiempo",
    engine: "timeline",
  ...
  {
    key: "contradictions",
    label: "Análisis de contradicciones",
  ...
  },
  {
    ...
    label: "Inteligencia de jurisdicción",
...

  {
    ...
    label: "Análisis de cumplimiento procesal",
  ...
  {
    key: "discovery",
    label: "Detección de brechas probatorias",
  ...
  },
  {
    ...
    key: "perspectives",
    label: "Análisis multiperspectiva",
    engine: "perspectives",
  ...
  {
    key: "opportunities",
    label: "Oportunidades estratégicas del caso",
    engine: "opportunity",
  ...
  {
    key: "hallucination",
    label: "Revisión de alucinaciones",
...

  {
    ...
    key: "multi_agent",
    label: "Revisión multiagente (13 agentes)",
    engine: "multi_agent",
