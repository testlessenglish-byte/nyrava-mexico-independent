          ...
          {MOBILE_TABS.map(({ to, labelKey, icon: Icon, primary }) => {
            ...
            if (primary) {
              return (
                ...
                >
                  <span className="grid h-12 w-12 -translate-y-3 place-items-center rounded-full bg-gradient-to-br from-primary to-accent text-primary-foreground shadow-[0_8px_24px_rgba(19,43,33,0.22)] ring-4 ring-sidebar">
